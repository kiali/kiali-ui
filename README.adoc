...
...
----
For a video on getting a Kiali-ui development environment running please see: https://www.youtube.com/watch?v=v4MN04nQNCU[Setting up Kiali-ui Dev environment]
(complete with tips/tricks).
