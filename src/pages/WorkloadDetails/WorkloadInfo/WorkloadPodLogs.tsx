...
export default class WorkloadPodLogs extends React.Component<WorkloadPodLogsProps, WorkloadPodLogsState> {
                    ...
                    <ToolbarGroup>
                      <ToolbarItem>
                        <TextInput
                          ...
                          autoComplete="on"
                          type="text"
                          onChange={this.handleShowLogLines}
                          defaultValue={this.state.showLogValue}
                          aria-label="log show text"
                          placeholder="Show..."
                        />
                      </ToolbarItem>
                      <ToolbarItem>
  ...
  private handleShowLogLines = (findValue: string) => {
    if (findValue === '') {
  ...
  private clearShow = () => {
    ...
    this.setState({ showLogValue: '', filteredAppLogs: undefined, filteredProxyLogs: undefined });
  };
