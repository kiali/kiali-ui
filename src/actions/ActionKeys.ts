export enum ActionKeys {
  ...
  GRAPH_TOOLBAR_TOGGLE_RANK_BY_INBOUND_EDGES = 'GRAPH_TOOLBAR_TOGGLE_RANK_BY_INBOUND_EDGES',
  GRAPH_TOOLBAR_TOGGLE_RANK_BY_OUTBOUND_EDGES = 'GRAPH_TOOLBAR_TOGGLE_RANK_BY_OUTBOUND_EDGES',
