...
import { Host } from '../../../types/IstioObjects';
...
export const serviceLink = (host: Host, namespaces: Namespace[] | undefined, podNamespace: string, simpleSvc: boolean=false): JSX.Element | string => {
