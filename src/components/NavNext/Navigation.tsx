...
import RenderPage from '../Nav/RenderPage';
import { RouteComponentProps } from 'react-router';

import LoginPage from '../../containers/LoginPageContainerNext';
...
import { BackgroundImage, BackgroundImageSrc } from '@patternfly/react-core/dist/js/components/BackgroundImage';
...
class Navigation extends React.Component<PropsType, NavigationState> {
  ...
  render() {
    ...
    const Sidebar = <Menu isNavOpen={isNavOpen} location={this.props.location} jaegerUrl={this.props.jaegerUrl} />;
