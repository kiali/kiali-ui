...
class JaegerToolbar extends React.Component<JaegerToolbarProps, JaegerToolbarState> {
  ...
  onChangeLookBackCustom = (step: string, dateField: string, timeField: string) => {
    let current = this.state.dateTimes;
...
const JaegerToolbarContainer = connect(
  mapStateToProps,
  mapDispatchToProps
)(JaegerToolbar);

export default JaegerToolbarContainer;
